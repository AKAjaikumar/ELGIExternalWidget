...
requirejs.config({
    ...
    var myWidget = {
        ...
        createPrjMng: function () {
            ...
            dropZone.addEventListener("drop", function (e) {
                ...
                try {
                    ...
                    if (dropped && dropped.objectId && (dropped.displayType === "Project Space" || dropped.objectType === "Project Space")) {
            ...
            const tplAttributes = [{
                    label : "Product Class",
                    type : "select",
                    options : ["E07", "C56", "E46", "S01", "S15", "G12", "E23", "B32", "S09", "S67", "B36", "E47"]
                }
            ];
                                    ...
                                    const createDocPayload = {
                                        data: [{
                                                attributes: {
                                                    ...
                                                    "extensions": ["XP_Document_Ext.DocumentType"]
                                                }
                                            }
                                        ]
                                    };
                                                                                                    ...
                                                                                                    WAFData.authenticatedRequest(getFolderURL, {
                                                                                                        ...
                                                                                                        onComplete: function (response) {
                                                                                                            try {
                                                                                                                ...
                                                                                                                const CRDFolder = json.data.find(item => item.dataelements && item.dataelements.title && item.dataelements.title.toLowerCase() === "crd");
                                                                                                                if (CRDFolder) {
                                                                                                                ...
                                                                                                                const specFolder = json.data.find(item => item.dataelements && item.dataelements.title && item.dataelements.title.toLowerCase() === "specification");
                                                                                                                if (specFolder) {
        ...
        mergeDocumentsIntoTable: function (docs) {
            ...
            const rows = docs.map(doc => [doc.dataelements ? .name || 'N/A', doc.dataelements ? .policy || 'N/A', doc.dataelements ? .state || 'N/A', doc.dataelements ? .DocumentType || 'N/A', doc.dataelements ? .originated || 'N/A']);
            return {
                headers,
                rows
            };
        ...
        dragDropArea: function (id, maxFiles, label) {
            ...
            wrapper.addEventListener('drop', async function (e) {
                ...
                try {
                    ...
                    if (json && json.protocol === "3DXContent" && Array.isArray(json.data ? .items)) {
